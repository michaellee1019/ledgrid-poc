(() => {
  ...
  function sceneFromControls() {
    ...
    if (choice !== next.animation.component_id) next.animation = ambientIds.includes(choice)
  ...
  syncSecondaryOperations(); installPixelStoryControls(); installAmbientControls(); wire(); applyScene(defaultScene());
