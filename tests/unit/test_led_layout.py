...
class LedLayoutTests(unittest.TestCase):
    ...
    def test_fifth_receiver_prefers_spi1_ce2(self):
        ...
        self.assertEqual(
            wall_device_map(5, lambda bus, device: (bus, device) != (1, 3)),
            [(0, 0), (0, 1), (1, 1), (1, 0), (1, 2)],
        )

    def test_rightmost_extra_strip_is_mirrored_on_the_fifth_receiver(self):
        self.assertEqual(EXTRA_STRIP_LANE, 0)
        self.assertTrue(MIRROR_EXTRA_STRIP_ON_ALL_LANES)

    def test_fifth_receiver_falls_back_to_spi1_ce3(self):
        existing = {(0, 0), (0, 1), (1, 0), (1, 1), (1, 3)}
        self.assertEqual(
            wall_device_map(5, lambda bus, device: (bus, device) in existing),
            [(0, 0), (0, 1), (1, 1), (1, 0), (1, 3)],
        )


class MultiDeviceLayoutTests(unittest.TestCase):
    def test_thirty_three_strips_pad_the_fifth_receiver(self):
        ...
        self.assertEqual(frames[4].shape, (16, 3))
