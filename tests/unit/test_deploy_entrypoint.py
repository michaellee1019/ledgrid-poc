        ...
        return tuple(
            {
                ...
                "transport_padding_bytes_sent": (
                    transfers * (27 if logical_id == 3 else 1)
                ),
                ...
                "bytes_sent": (
                    ...
                    + transfers * (27 if logical_id == 3 else 1)
                    + crc_bytes
                    + transfers * (730 if logical_id == 3 else 0)
                ),
                "fec_frames_sent": transfers if logical_id == 3 else 0,
                "fec_codewords_sent": 68 * transfers if logical_id == 3 else 0,
                "fec_parity_bytes_sent": 730 * transfers if logical_id == 3 else 0,
                "fec_data_padding_bytes_sent": 26 * transfers if logical_id == 3 else 0,
    ...
    def test_production_health_accepts_fec_parity_and_outer_header_accounting(self) -> None:
        def with_fec(
            ...
            receiver.update({
                ...
                "fec_parity_bytes_sent": 730 * frames,
        ...
        before_statuses = with_fec(self._receiver_statuses(
            version=3, capabilities=0x1FC00C, responses=2,
        ))
        after_statuses = with_fec(self._receiver_statuses(
            version=3, capabilities=0x1FC00C, responses=3,
        ))
