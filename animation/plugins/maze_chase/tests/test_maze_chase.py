...
class MazeChaseAnimationTests(unittest.TestCase):
    ...
    def test_default_chase_cadence_is_bounded_and_local(self):
        animation = self.make_animation()
        self.assertEqual(animation.params["chase_cadence_hz"], 9.0)
        self.assertEqual(animation.get_parameter_schema()["chase_cadence_hz"]["default"], 9.0)
