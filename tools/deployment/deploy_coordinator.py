...
FULL_STEP_ORDER: Tuple[Tuple[str, bool, str], ...] = (
    ...
    (
        ...
        False,
        "validate identity rotation evidence before receiver mutation",
    ),
    ...
    (
        "receiver.identity_refresh",
        True,
        "refresh and validate receiver identity authority",
    ),
...
STEP_TIMING_EXPECTATIONS: Mapping[str, str] = {
    ...
    "receiver.identity_refresh": "normally <1s",
